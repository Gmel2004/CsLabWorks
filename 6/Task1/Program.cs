...
namespace Task1
{
    internal class Program
    {
        ...
        private static void RemoveAllDigits(ref char[] array)//Удалить все цифры из одномерного массива
        {
            if (array.Length == 0)
            {
                Console.WriteLine("Массив пуст! Выполнение операции невозможно!");
        ...
        public static void WriteArray(char[] array)//Вывести одномерный массив
        {
            Console.WriteLine("{" + string.Join(", ", array) + '}');
        }
    }
